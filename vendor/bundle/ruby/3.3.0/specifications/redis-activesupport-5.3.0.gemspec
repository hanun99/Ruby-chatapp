...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<redis-store>.freeze, [">= 1.3".freeze, "< 2".freeze])
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 3".freeze, "< 8".freeze])
  ...
  s.add_development_dependency(%q<connection_pool>.freeze, ["= 2.2.2".freeze])
